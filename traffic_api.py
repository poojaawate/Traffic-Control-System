...
traffic_api = TrafficApi(api_key="vNZrIhLRfqj6e9b-B8oJIwnCpR5Y0-rmdYuLCu1dBug")
...
response = traffic_api.flow_within_boundingbox(
    top_left=[18.347700, 73.868134], bottom_right=[18.345700, 73.871134]
)
print(response.as_dict())

# traffic flow for a circle around a defined point
response = traffic_api.flow_using_proximity(
    latitude=18.347700, longitude=73.868134, distance=5
)
print(response.as_dict())
